...
require_once "../../init.php";
	...
	function obtener_categorias(){
		if(isset($_POST["obtener"])) {
			...
			$categorias = Db::getInstance()->executeS("SELECT id_category,obuma_id_category  as producto_categoria_id,name_category as producto_categoria_nombre FROM "._DB_PREFIX_."obuma_vincular_categorias WHERE obuma_id_category > 0 ORDER BY name_category ASC");
